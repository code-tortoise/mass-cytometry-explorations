...
bioc_pkgs <- c(
    "imcdatasets", "SingleCellExperiment", "SpatialExperiment",
    "cytomapper", "HDF5Array", "ExperimentHub"
)
cran_pkgs <- c("ggplot2", "dplyr", "patchwork")
...
if (length(missing_bioc) > 0 || length(missing_cran) > 0) {
    if (!requireNamespace("BiocManager", quietly = TRUE))
        install.packages("BiocManager")
